...
help:
	...
	@echo "  up-auth        Start db + auth (no world)"
	@echo "  up-all         Start db + world + auth (foreground)"
	@echo "  extract-force  Force extraction of dbc/db2/cameras/maps/vmaps (runs inside world)"
	...
	@echo "  clean          Down + remove volumes (fresh start)"
	@echo "  prune          Prune unused Docker data (asks confirmation)"
